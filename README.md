...
* [`ft_isascii`](libft/blob/main/libft/ft_isascii.c) - test for ASCII character.
* [`ft_isalnum`](libft/blob/main/libft/ft_isalnum.c) - alphanumeric character test.
* [`ft_isalpha`](libft/blob/main/libft/ft_isalpha.c) - alphabetic character test.
* [`ft_islower`](libft/blob/main/libft/ft_islower.c) * - lower-case character test.
* [`ft_isupper`](libft/blob/main/libft/ft_isupper.c) * - upper-case character test.
* [`ft_isdigit`](libft/blob/main/libft/ft_isdigit.c) - decimal-digit character test.
* [`ft_isxdigit`](libft/blob/main/libft/ft_isxdigit.c) * - hexadecimal-digit character test.
* [`ft_isprint`](libft/blob/main/libft/ft_isprint.c) - printing character test (space character inclusive).
* [`ft_isgraph`](libft/blob/main/libft/ft_isgraph.c) * - printing character test (space character exclusive).
* [`ft_isspace`](libft/blob/main/libft/ft_isspace.c) * - white-space character test.
* [`ft_isblank`](libft/blob/main/libft/ft_isblank.c) * - space or tab character test.
* [`ft_ispunct`](libft/blob/main/libft/ft_ispunct.c) * - punctuation character test.
* [`ft_iscntrl`](libft/blob/main/libft/ft_iscntrl.c) * - control character test.
* [`ft_tolower`](libft/blob/main/libft/ft_tolower.c) - upper case to lower case letter conversion.
* [`ft_toupper`](libft/blob/main/libft/ft_toupper.c) - lower case to upper case letter conversion.

### Functions from `<stdlib.h>` library

* [`ft_atoi`](libft/blob/main/libft/ft_atoi.c) - convert ASCII string to integer.
* [`ft_atof`](libft/blob/main/libft/ft_atof.c) * - convert ASCII string to integer.
* [`ft_calloc`](libft/blob/main/libft/ft_calloc.c) - memory allocation.

### Functions from `<strings.h>` library

* [`ft_bzero`](libft/blob/main/libft/ft_bzero.c) - write zeroes to a byte string.
* [`ft_memset`](libft/blob/main/libft/ft_memset.c) - write a byte to a byte string.
* [`ft_memchr`](libft/blob/main/libft/ft_memchr.c) - locate byte in byte string.
* [`ft_memcmp`](libft/blob/main/libft/ft_memcmp.c) - compare byte string.
* [`ft_memmove`](libft/blob/main/libft/ft_memmove.c) - copy byte string.
* [`ft_memcpy`](libft/blob/main/libft/ft_memcpy.c) - copy memory area.
* [`ft_memccpy`](libft/blob/main/libft/ft_memccpy.c) - copy string until character found.

### Functions from `<string.h>` library

* [`ft_strlen`](libft/blob/main/libft/ft_strlen.c) - find length of string.
* [`ft_strchr`](libft/blob/main/libft/ft_strchr.c) - locate character in string (first occurrence).
* [`ft_strrchr`](libft/blob/main/libft/ft_strrchr.c) - locate character in string (last occurence).
* [`ft_strstr`](libft/blob/main/libft/ft_strstr.c) * - locate a substring in a string.
* [`ft_strnstr`](libft/blob/main/libft/ft_strnstr.c) - locate a substring in a string (size-bounded).
* [`ft_strcmp`](libft/blob/main/libft/ft_strcmp.c) * - compare strings.
* [`ft_strncmp`](libft/blob/main/libft/ft_strncmp.c) * - compare strings (size-bounded).
* [`ft_strnrcmp`](libft/blob/main/libft/ft_strnrcmp.c) - reversely compare strings (size-bounded).
* [`ft_strcpy`](libft/blob/main/libft/ft_strcpy.c) * - copy strings.
* [`ft_strncpy`](libft/blob/main/libft/ft_strncpy.c) * - copy strings (size-bounded).
* [`ft_strdup`](libft/blob/main/libft/ft_strdup.c) - save a copy of a string (with malloc).
* [`ft_strndup`](libft/blob/main/libft/ft_strndup.c) * - save a copy of a string (with malloc, size-bounded).
* [`ft_strcat`](libft/blob/main/libft/ft_strcat.c) * - concatenate strings (s2 into s1).
* [`ft_strncat`](libft/blob/main/libft/ft_strncat.c) * - concatenate strings (s2 into s1, size-bounded).
* [`ft_strlcpy`](libft/blob/main/libft/ft_strlcpy.c) - size-bounded string copying.
* [`ft_strlcat`](libft/blob/main/libft/ft_strlcat.c) - size-bounded string concatenation.

### Non-standard functions

* [`ft_swap`](libft/blob/main/libft/ft_swap.c) * - swap value of two integers.
